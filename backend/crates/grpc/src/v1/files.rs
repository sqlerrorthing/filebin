...
use crate::schema::api::folder::v1::{
    Blob, DownloadRequest, ListFilesRequest, ListFilesResponse, UploadFileRequest,
...
pub struct BasicGrpcFilesService<FilesS, FoldersS, DS, US> {
...
#[async_trait]
impl<FilesS, FoldersS, DS, US> FilesService for BasicGrpcFilesService<FilesS, FoldersS, DS, US>
where
