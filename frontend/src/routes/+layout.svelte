...
<Toaster
    ...
    toastOptions={{
        ...
        classes: {
            ...
            actionButton: 'inline-flex shrink-0 items-center justify-center rounded-md bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
            cancelButton: 'inline-flex shrink-0 items-center justify-center rounded-md bg-secondary px-3 py-1.5 text-xs font-medium text-secondary-foreground transition-colors hover:bg-secondary/80 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
            closeButton: 'absolute right-2 top-2 rounded-md p-1 text-muted-foreground/50 opacity-0 transition-opacity hover:text-foreground group-hover:opacity-100',

            default: 'border-border bg-popover text-popover-foreground',
            success: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-900 dark:text-emerald-200 [&_[data-icon]]:text-emerald-500',
            error: 'border-destructive/30 bg-destructive/10 text-destructive dark:text-red-300 [&_[data-icon]]:text-destructive',
            warning: 'border-amber-500/30 bg-amber-500/10 text-amber-900 dark:text-amber-200 [&_[data-icon]]:text-amber-500',
