...
>
    <div
        class="bg-card relative flex w-full max-w-md flex-col gap-4 border p-6
            shadow-lg"
    >
        <button
            class="text-muted-foreground hover:text-foreground absolute top-4
        ...
        {:else if shareState.step === "sas"}
            <div class="flex flex-col items-center justify-center gap-4 py-4">
                ...
                <button
                    class="bg-primary text-primary-foreground flex w-full
                        cursor-pointer items-center justify-center gap-2 py-2
        ...
        {:else if shareState.step === "success"}
            <div class="flex flex-col items-center justify-center gap-4 py-8">
                ...
                <button
                    class="bg-muted hover:bg-muted/80 cursor-pointer px-4 py-2
                        text-sm"
                    onclick={handleClose}
                >
