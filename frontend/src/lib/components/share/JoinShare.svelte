...
<div
    class="bg-card border-muted-foreground flex w-full flex-col gap-3 border
        border-dashed p-4"
>
    ...
    {:else if joinState.step === "connecting"}
        <div
            class="text-muted-foreground flex flex-col items-center
                justify-center gap-3 py-4"
        >
            ...
            <button
                type="button"
                class="bg-muted hover:bg-muted/80 text-foreground cursor-pointer
                    px-3 py-1 text-xs"
    ...
    {:else if joinState.step === "sas"}
        ...
        <div class="flex flex-col items-center justify-center gap-3 py-2">
            ...
            <div
                class="bg-muted flex max-w-full flex-wrap items-center
                    justify-center gap-2 p-4 sm:gap-4"
            >
            ...
            <button
                type="button"
                class="bg-muted hover:bg-muted/80 text-foreground mt-2
    ...
    {:else if joinState.step === "decrypting"}
        <div
            class="text-muted-foreground flex items-center justify-center gap-2
                py-4"
        >
            <LoaderCircle class="text-primary h-5 w-5 animate-spin" />
