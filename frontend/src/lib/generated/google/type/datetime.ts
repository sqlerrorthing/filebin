...
export const DateTime: MessageFns<DateTime> = {
  ...
  fromJSON(object: any): DateTime {
    return {
      ...
      utcOffset: isSet(object.utcOffset)
        ? Duration.fromJSON(object.utcOffset)
        : isSet(object.utc_offset)
        ? Duration.fromJSON(object.utc_offset)
        : undefined,
      timeZone: isSet(object.timeZone)
        ? TimeZone.fromJSON(object.timeZone)
        : isSet(object.time_zone)
        ? TimeZone.fromJSON(object.time_zone)
        : undefined,
    };
  },
